...
//	cellFrame.size.width = [controlView bounds].size.width;
	...
	if (titleColor == nil)
		...
		titleColor = [[[NSColor colorWithDeviceRed:139.0f/255.0f green:146.0f/255.0f blue:157.0f/255.0f alpha:1.0f] highlightWithLevel:0.4f] retain];
	[attributes setObject:titleColor forKey:NSForegroundColorAttributeName];

	NSAttributedString *titleString = [[[NSAttributedString alloc] initWithString:self.stringValue attributes:attributes] autorelease];
