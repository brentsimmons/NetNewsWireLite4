...
- (BOOL)appBundleIDIsBrowser:(NSString *)appBundleID {
    ...
    if (knownBrowserBundleIDs == nil)
        knownBrowserBundleIDs = [NSArray arrayWithObjects:@"org.mozilla.firefox", @"com.apple.safari", @"com.google.Chrome", @"com.operasoftware.Opera", @"com.omnigroup.OmniWeb5", @"org.mozilla.camino", nil];
...
- (void)addCommandsForOpenURLApps:(NSArray *)openURLApps toArray:(NSMutableArray *)anArray {
    ...
    for (NSString *oneAppBundleID in openURLApps) {
        ...
        NNWPluginCommandOpenInAnyBrowser *onePluginCommand = [[NNWPluginCommandOpenInAnyBrowser alloc] initWithAppName:oneAppName bundleID:oneAppBundleID path:oneAppPath];
...
- (NSArray *)buildCommands {
    ...
    NSArray *openURLApps = (NSArray *)CFBridgingRelease(LSCopyAllHandlersForURLScheme((__bridge_retained CFStringRef)protoString ));
