...
@property (nonatomic, retain) RSTreeNode *treeNode;
@property (nonatomic, retain) NSString *folderName;
@property (nonatomic, retain) NSArray *objectIDsOfDeletedArticles;
@end
...
- (void)dealloc {
	[treeNode release];
	[folderName release];
	[objectIDsOfDeletedArticles release];
	[super dealloc];
}
...
@property (nonatomic, retain) RSTreeNode *itemBeingEdited;
...
- (void)dealloc {
	...
	[itemBeingEdited release];
	[selectedOutlineItems release];
	[sourceListOutlineView release];
...
- (void)awakeFromNib {
	...
	NNWSourceListCell *sourceListCell = [[[NNWSourceListCell alloc] init] autorelease];
...
- (void)addAction:(SEL)anAction title:(NSString *)aTitle toMenu:(NSMenu *)aMenu {
	NNWSourceListValidatedUserInterfaceItem *item = [[[NNWSourceListValidatedUserInterfaceItem alloc] init] autorelease];
...
- (NSMenu *)contextualMenuForFeed:(RSFeed *)feed {
	NSMenu *menu = [[[NSMenu alloc] initWithTitle:@"Folder Contextual Menu"] autorelease];
