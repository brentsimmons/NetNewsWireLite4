...
@property (nonatomic, strong) NSMutableArray *enqueuedViews;
@property (nonatomic, strong) NSMutableArray *visibleViews;
@property (nonatomic, strong) NSMutableDictionary *rowToViewMap;
@property (nonatomic, assign) NSUInteger numberOfRows;
@property (nonatomic, strong, readwrite) NSIndexSet *selectedRowIndexes;
...
- (void)commonInit {
    enqueuedViews = [NSMutableArray array];
    visibleViews = [NSMutableArray array];
    selectedRowIndexes = [NSIndexSet indexSet];
    rowToViewMap = [NSMutableDictionary dictionary];
}
...
//    RSCGRectFillWithWhite(r);
    ...
    if (backgroundColor == nil)
        backgroundColor = [[NSColor colorWithDeviceRed:139.0f/255.0f green:146.0f/255.0f blue:157.0f/255.0f alpha:1.0f] highlightWithLevel:0.4f];
