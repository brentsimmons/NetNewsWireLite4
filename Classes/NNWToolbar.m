...
- (NSArray *)itemsThatWillFit {
    ...
    NSMutableArray *itemsThatWillFit = [self.toolbarItems mutableCopy];
    while (true) {
...
- (void)drawRect:(NSRect)r {
    ...
    if (frameColor == nil)
        frameColor = [NSColor colorWithCalibratedRed:145.0f/255.0f green:145.0f/255.0f blue:145.0f/255.0f alpha:1.0f];
