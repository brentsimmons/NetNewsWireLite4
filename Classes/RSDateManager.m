...
@property (nonatomic, strong) NSCalendar *userCalendar;
@property (nonatomic, strong, readwrite) NSDate *firstSecondOfToday;
@property (nonatomic, strong, readwrite) NSDate *firstSecondOfTomorrow;
@property (nonatomic, strong) NSDate *firstSecondOfYesterday;
...
- (id)init {
    ...
    recalculateDatesTimer = [NSTimer scheduledTimerWithTimeInterval:60 * 15 target:self selector:@selector(recalculateDates) userInfo:nil repeats:YES];
