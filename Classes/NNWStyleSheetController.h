...
@property (nonatomic, retain, readonly) NSArray *styleSheetNames;
@property (nonatomic, retain, readonly) NNWArticleTheme *defaultArticleTheme; //user's global setting (set in NSUserDefaults)


#pragma mark NNWStyleDocument Support

@property (nonatomic, retain, readonly) NSString *installError;
