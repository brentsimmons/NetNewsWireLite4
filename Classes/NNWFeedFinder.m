...
@property (nonatomic, unsafe_unretained) id<NNWFeedFinderDelegate> delegate;
@property (nonatomic, assign, readwrite) NSInteger statusCode;
@property (nonatomic, strong) NSMutableDictionary *urlsRead;
@property (nonatomic, strong) NSTimer *keepAliveTimer;
@property (nonatomic, strong) NSURLRequest *urlRequest;
@property (nonatomic, strong, readwrite) NSMutableData *responseBody;
@property (nonatomic, strong, readwrite) NSURL *originalURL;
@property (nonatomic, strong, readwrite) NSURL *permanentURL;
...
- (id)initWithURL:(NSURL *)url delegate:(id<NNWFeedFinderDelegate>)aDelegate {
    ...
    originalURL = url;
    delegate = aDelegate;
    urlsRead = [NSMutableDictionary dictionaryWithCapacity:20];
    return self;
}
...
- (void)_beginFindFeed:(NSURL *)url {
    @autoreleasepool {
        ...
        self.keepAliveTimer = [[NSTimer alloc] initWithFireDate:[NSDate distantFuture] interval:60 * 60 * 24 * 365 * 10 target:self selector:@selector(_bogusSelector) userInfo:nil repeats:NO];
...
- (void)_readURL:(NSURL *)url {
    @autoreleasepool {
        ...
        (void)[[NSURLConnection alloc] initWithRequest:aURLRequest delegate:self];
    }
}
