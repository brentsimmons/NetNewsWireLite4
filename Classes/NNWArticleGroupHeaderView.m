...
//    CGContextSetAlpha(context, 0.5f);
    ...
    if (frameColor == nil)
        frameColor = [NSColor colorWithCalibratedRed:139.0f/255.0f green:146.0f/255.0f blue:157.0f/255.0f alpha:1.0f];
...
//    RSCGRectFillWithColor(rTopWhiteLine, topInnerShadowColor);
    ...
    dateColor = [[NSColor colorWithDeviceRed:238.0f/255.0f green:238.0f/255.0f blue:238.0f/255.0f alpha:1.0f] shadowWithLevel:0.30f];
    ...
    NSAttributedString *titleString = [[NSAttributedString alloc] initWithString:[self.title uppercaseString] attributes:attributes];
