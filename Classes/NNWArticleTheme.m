...
@property (nonatomic, strong, readwrite) NSString *cssFilePath;
@property (nonatomic, strong, readwrite) NSString *emptyCSSFilePath;
...
- (id)initWithFolderPath:(NSString *)aFolderPath {
    ...
    nameForDisplay = [[folderPath lastPathComponent] stringByDeletingPathExtension];
    cssFilePath = [folderPath stringByAppendingPathComponent:@"stylesheet.css"];
    ...
    if (RSFileExists(anEmptyCSSFilePath))
        emptyCSSFilePath = anEmptyCSSFilePath;
    else
