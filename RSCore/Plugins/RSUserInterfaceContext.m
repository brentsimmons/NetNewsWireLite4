...
#else
@property (nonatomic, retain, readwrite) NSWindow *window;
@property (nonatomic, retain, readwrite) NSViewController *rootViewController;
@property (nonatomic, retain, readwrite) NSViewController *hostViewController;
@property (nonatomic, retain, readwrite) NSEvent *event;
@property (nonatomic, retain, readwrite) NSView *view;
@property (nonatomic, retain, readwrite) NSControl *control;
#endif
...
+ (RSUserInterfaceContext *)contextWithViewController:(id)aViewController view:(id)aView control:(id)aControl barButtonItem:(id)aBarButtonItem event:(id)anEvent {
	return [[[self alloc] initWithViewController:aViewController view:aView control:aControl barButtonItem:aBarButtonItem event:anEvent] autorelease];
}
...
- (RSUserInterfaceContext *)initWithViewController:(id)aViewController view:(id)aView control:(id)aControl barButtonItem:(id)aBarButtonItem event:(id)anEvent {
	...
	if (self == nil)
		return nil;
	hostViewController = [aViewController retain];
	view = [aView retain];
#if TARGET_OS_IPHONE
	...
	window = [[self findWindow:aView] retain];
	rootViewController = [[self findRootViewController:aView] retain];
