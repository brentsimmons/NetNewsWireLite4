...
UIImage *TLImageWithAlpha(UIImage *image) {
...
- (UIImage *)transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRelease(maskImageRef); /*Static analyzer false positive*/
...
- (CGImageRef)createBorderMask:(NSUInteger)borderSize size:(CGSize)size {
    ...
    return maskImageRef;  /*Static analyzer false positive: released in caller*/
}
