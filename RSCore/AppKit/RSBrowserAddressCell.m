...
//            
//            
            backgroundColor = [[NSColor colorWithDeviceRed:139.0f/255.0f green:146.0f/255.0f blue:157.0f/255.0f alpha:1.0f] highlightWithLevel:0.6f];
        [backgroundColor set];
...
//    [[NSColor rs_borderColor] set];
    ...
    if (borderColor == nil)
        borderColor = [NSColor colorWithDeviceWhite:238.0f/255.0f alpha:1.0f];
    [borderColor set];
    //[p stroke];
