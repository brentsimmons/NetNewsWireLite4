...
@property (nonatomic, strong) NSMutableDictionary *listControllers;
@property (nonatomic, strong) NSTimer *saveTimer;
@property (nonatomic, strong, readonly) NSOperationQueue *coreDataBackgroundOperationQueue;
@property (nonatomic, strong, readonly) RSCoreDataStack *coreDataStack;
@property (nonatomic, strong, readwrite) RSGlobalAccount *globalAccount;
...
- (id)initWithModelResourceName:(NSString *)modelResourceName storeFileName:(NSString *)storeFileName {
    ...
    if (self == nil)
        return nil;
    listControllers = [NSMutableDictionary dictionary];
