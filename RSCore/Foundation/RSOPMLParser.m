...
@property (nonatomic, strong) NSMutableArray *outlineDictStack;
@end
...
- (id)init {
    if (![super init])
        return nil;
    outlineItems = [NSMutableArray arrayWithCapacity:200];
    flattenedOutlineItems = [NSMutableArray arrayWithCapacity:200];
    outlineDictStack = [NSMutableArray arrayWithCapacity:10];
    return self;
}
