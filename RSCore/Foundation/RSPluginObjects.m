...
@property (nonatomic, strong, readwrite) NSString *uti;
@property (nonatomic, strong, readwrite) NSURL *URL;
@property (nonatomic, strong, readwrite) NSData *itemData;
@property (nonatomic, strong, readwrite) NSString *htmlText;
@property (nonatomic, strong, readwrite) NSString *selectedText;
@property (nonatomic, strong, readwrite) NSString *title;
@property (nonatomic, strong, readwrite) id<RSFeedSpecifier> feed;
@property (nonatomic, strong, readwrite) NSURL *permalink;
...
+ (id<RSSharableItem>)sharableItemWithURL:(NSURL *)aURL {
    RSSharableItem *sharableItem = [[RSSharableItem alloc] init];
