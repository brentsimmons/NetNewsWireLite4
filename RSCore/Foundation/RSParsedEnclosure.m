...
- (id)initWithFeedEnclosureDictionary:(NSDictionary *)enclosureDict {
	...
	mimeType = [[enclosureDict objectForKey:RSParsedEnclosureMimeTypeKey] retain];
	if (RSStringIsEmpty(mimeType))
		mimeType = [[enclosureDict objectForKey:RSParsedEnclosureMimeType2Key] retain];
	medium = [[enclosureDict objectForKey:RSParsedEnclosureMediumKey] retain];
