...
@property (nonatomic, strong, readonly) NSMutableDictionary *cacheDictionary;
@property (nonatomic, strong, readonly) id nativeCache;
@end
...
- (id)objectForKey:(id)key {
    ...
    id obj = [self.cacheDictionary objectForKey:key];
