...
@property (nonatomic, strong) RSHTTPConditionalGetInfo *conditionalGetInfo;
@property (nonatomic, strong) NSURL *feedURL;
...
@property (nonatomic, strong) NSData *feedContentHash;
@property (nonatomic, strong) NSURL *feedURL;
...
- (id)initWithDatabaseFileName:(NSString *)databaseName createTableStatement:(NSString *)createTableStatement {
    ...
    databaseKey = [NSString stringWithFormat:@"%@_cachedDatabaseKey", databaseName];
    refcountKey = [NSString stringWithFormat:@"%@_cachedRefCountKey", databaseName];
    
    NSString *folderPath = rs_app_delegate.pathToCacheFolder;//RSCacheFolderForApp(YES);
    if (RSStringIsEmpty(folderPath))
        return nil;
    databaseFilePath = [folderPath stringByAppendingPathComponent:RSLocalAccountFeedMetadataCacheFileName];
...
- (void)setConditionalGetInfo:(RSHTTPConditionalGetInfo *)conditionalGetInfo forFeedURL:(NSURL *)feedURL {
    RSSaveConditionalGetInfoOperation *saveConditionalGetInfoOperation = [[RSSaveConditionalGetInfoOperation alloc] initWithConditionalGetInfo:conditionalGetInfo feedURL:feedURL];
...
- (void)setContentHash:(NSData *)contentHash forFeedURL:(NSURL *)feedURL {
    RSSaveFeedContentHashOperation *saveFeedContentHashOperation = [[RSSaveFeedContentHashOperation alloc] initWithFeedContentHash:contentHash feedURL:feedURL];
...
- (void)deleteInfoForFeedURL:(NSURL *)feedURL {
    NSParameterAssert(feedURL != nil);
    RSDeleteFeedInfoOperation *deleteFeedInfoOperation = [[RSDeleteFeedInfoOperation alloc] initWithFeedURL:feedURL];
...
- (id)initWithConditionalGetInfo:(RSHTTPConditionalGetInfo *)someConditionalGetInfo feedURL:(NSURL *)aFeedURL {
    ...
    if (self == nil)
        return nil;
    conditionalGetInfo = someConditionalGetInfo;
    feedURL = aFeedURL;
    return self;
}
...
- (id)initWithFeedContentHash:(NSData *)aFeedContentHash feedURL:(NSURL *)aFeedURL {
    ...
    if (self == nil)
        return nil;
    feedContentHash = aFeedContentHash;
    feedURL = aFeedURL;
    return self;    
}
