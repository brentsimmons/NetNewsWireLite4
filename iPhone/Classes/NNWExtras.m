...
//	return !obj || ([obj respondsToSelector:@selector(length)] && [obj length] == 0) || ([obj respondsToSelector:@selector(count)] && [obj count] == 0);
//}
...
+ (NSString *)contextualDateStringWithDate:(NSDate *)d {
	...
	if ([dateComponents year] == year && [dateComponents month] == month && [dateComponents day] == day)
		return [NSString stringWithFormat:@"Today, %@", [timeFormatter stringFromDate:d]];		
	if ([dateComponents year] == yesterdayYear && [dateComponents month] == yesterdayMonth && [dateComponents day] == yesterdayDay)
		return [NSString stringWithFormat:@"Yesterday, %@", [timeFormatter stringFromDate:d]];
	...
	return [dateTimeFormatter stringFromDate:d];
}
...
//@interface UINavigationBar (NNWExtras)
//- (void)drawRect:(CGRect)rect;
//@end
//
//@implementation UINavigationBar (NNWExtras)
//
//- (void)drawRect:(CGRect)rect {
